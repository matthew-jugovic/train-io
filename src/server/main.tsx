    ...
    upgradeWebSocket(() => {
      return {
        ...
        onClose: (_evt, ws) => {
          ...
          console.log(
            `WebSocket connection closed. Total clients: ${connected_ws_clients.size}`
          );
          broadcast({
            type: "update_player_count",
            data: { newCount: connected_ws_clients.size },
        ...
        onMessage: (evt, ws) => {
          ...
          if (data.type === "public_message") {
            ...
            publicMessageObject.data.username =
              publicMessageObject.data.username.trim().slice(0, 20);
            publicMessageObject.data.message = publicMessageObject.data.message
              .trim()
              .slice(0, 140);
            ...
            connected_ws_clients.forEach((_clientID, clientWs) => {
